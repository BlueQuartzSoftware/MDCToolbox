...
message(STATUS "MDCToolProj_RELEASE_TYPE: ${MDCToolProj_RELEASE_TYPE}")
if("${MDCToolProj_RELEASE_TYPE}" STREQUAL "Official")
  set(MDCTool_VERSION_SHORT "${MDCToolProj_VERSION_MAJOR}.${MDCToolProj_VERSION_MINOR}.${MDCToolProj_VERSION_PATCH}")
elseif("${MDCToolProj_RELEASE_TYPE}" STREQUAL "Beta")
  set(MDCTool_VERSION_SHORT "${MDCToolProj_VERSION_MAJOR}.${MDCToolProj_VERSION_MINOR}-${MDCToolProj_RELEASE_TYPE}-${MDCToolProj_VERSION_TWEAK}")
elseif("${MDCToolProj_RELEASE_TYPE}" STREQUAL "Development")
  set(MDCTool_VERSION_SHORT "${MDCToolProj_VERSION_MAJOR}.${MDCToolProj_VERSION_MINOR}.${MDCToolProj_VERSION_PATCH}.${MDCToolProj_VERSION_TWEAK}")
else()
  set(MDCTool_VERSION_SHORT "0.0.0")
endif()


message(STATUS "MDCTool_VERSION_SHORT: ${MDCTool_VERSION_SHORT}")
...
SET(CPACK_PACKAGE_VERSION_MAJOR ${MDCTool_VER_MAJOR})
SET(CPACK_PACKAGE_VERSION_MINOR ${MDCTool_VER_MINOR})
SET(CPACK_PACKAGE_VERSION_PATCH ${MDCTool_VER_PATCH})
SET(CPACK_PACKAGE_VERSION ${MDCTool_VERSION})


set(CPACK_PACKAGE_EXECUTABLES
    MDCTool MDCTool StatsGenerator StatsGenerator DevHelper DevHelper)
set(UPLOAD_FILE_NAME "")

if(APPLE)
    set(CPACK_PACKAGE_FILE_NAME "MDCTool-${MDCTool_VERSION_SHORT}-OSX")
...
elseif(WIN32)
    if( "${CMAKE_SIZEOF_VOID_P}" EQUAL "8" )
            set(CPACK_PACKAGE_FILE_NAME "MDCTool-${MDCTool_VERSION_SHORT}-Win64")
            set(UPLOAD_FILE_NAME ${CPACK_PACKAGE_FILE_NAME}.zip)
    elseif( "${CMAKE_SIZEOF_VOID_P}" EQUAL "4" )
            set(CPACK_PACKAGE_FILE_NAME "MDCTool-${MDCTool_VERSION_SHORT}-Win32")
            set(UPLOAD_FILE_NAME ${CPACK_PACKAGE_FILE_NAME}.zip)
    else()
        set(CPACK_PACKAGE_FILE_NAME "MDCTool-${MDCTool_VERSION_SHORT}-Unknown")
        set(UPLOAD_FILE_NAME ${CPACK_PACKAGE_FILE_NAME}.zip)
    endif()
else()
    if( "${CMAKE_SIZEOF_VOID_P}" EQUAL "8" )
            set(CPACK_PACKAGE_FILE_NAME "MDCTool-${MDCTool_VERSION_SHORT}-${MDCTool_LINUX_SYSTEM}-x86_64")
            set(UPLOAD_FILE_NAME ${CPACK_PACKAGE_FILE_NAME}.tar.gz)
    elseif( "${CMAKE_SIZEOF_VOID_P}" EQUAL "4" )
            set(CPACK_PACKAGE_FILE_NAME "MDCTool-${MDCTool_VERSION_SHORT}-${MDCTool_LINUX_SYSTEM}-i386")
            set(UPLOAD_FILE_NAME ${CPACK_PACKAGE_FILE_NAME}.tar.gz)
    else()
        set(CPACK_PACKAGE_FILE_NAME "MDCTool-${MDCTool_VERSION_SHORT}-${CMAKE_SYSTEM_NAME}")
        set(UPLOAD_FILE_NAME ${CPACK_PACKAGE_FILE_NAME}.tar.gz)
    endif()
endif()
...
SET(CPACK_SOURCE_PACKAGE_FILE_NAME "CDAF-${MDCTool_VERSION_SHORT}-Source")
